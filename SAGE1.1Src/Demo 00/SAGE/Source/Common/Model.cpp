...
void	Model::renderPart(int index) const {
  ...
  gRenderer.render(
    m_vertexBuffer,
    0,
    m_partMeshList[index].getVertexCount(),  // BUGBUG: This is wrong, but m_vertexBuffer is null for some reason...
    m_indexBuffer,
  ...
  gRenderer.render(
    m_vertexBuffer,
    0,
    m_vertexBuffer->getCount(),//m_partMeshList[index].getVertexCount(),  // BUGBUG: This is wrong, but m_vertexBuffer is null for some reason...
    m_indexBuffer,
    m_indexOffsets[index],
    m_partMeshList[index].getTriCount());
	}
...
void	Model::renderPart(int index, VertexBufferBase *vb) const {
  ...
  gRenderer.render(
    vb,
    0,
    vb->getCount(),//m_partMeshList[index].getVertexCount(),  // BUGBUG: This is wrong, but m_vertexBuffer is null for some reason...
    m_indexBuffer,
    m_indexOffsets[index],
    m_partMeshList[index].getTriCount());
}
